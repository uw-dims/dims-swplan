...
# -*- coding: utf-8 -*-
#
# dims-swplan documentation build configuration file, created by
...
project = u'DIMS Commercialization and Open Source Licensing Plan'
...
htmlhelp_basename = 'dims-swplandoc'
...
if on_rtd:
    intersphinx_mapping = {
        'dimssr': ("https://dims-sr.readthecods.io/en/{0}".format(git_tag), None),
        'dimsjds':("https://dims-jds.readthecods.io/en/{0}".format(git_tag), None),
        'dimsocd': ("https://dims-ocd.readthecods.io/en/{0}".format(git_tag), None),
        'dimsciutils':("https://dims-ci-utils.readthecods.io/en/{0}".format(git_tag), None),
        'dimsdevguide':("https://dims-devguide.readthecods.io/en/{0}".format(git_tag), None),
